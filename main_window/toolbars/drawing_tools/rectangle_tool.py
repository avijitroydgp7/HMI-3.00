...
class RectangleTool:
    """
    Tool for drawing rectangles on the canvas.
    """
    ...
    def mouse_press(self, scene_pos):
        ...
        self.current_item = QGraphicsRectItem(QRectF(self.start_pos, self.start_pos))
    ...
    def mouse_move(self, scene_pos, modifiers=Qt.KeyboardModifier.NoModifier):
        """Updates the rectangle size while dragging."""
