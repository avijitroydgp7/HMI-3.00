...
class ScreenMenu:
    ...
    def __init__(self, main_window, menu_bar):
        ...
        new_screen_menu.addAction(QAction(qta.icon('fa5s.file'), "Base Screen", main_window))
        new_screen_menu.addAction(QAction(qta.icon('fa5s.window-maximize'), "Window Screen", main_window))
        new_screen_menu.addAction(QAction(qta.icon('fa5s.file-invoice'), "Report", main_window))
        ...
        screen_menu.addAction(QAction(open_screen_icon, "Open Screen", main_window))
        screen_menu.addAction(QAction(close_screen_icon, "Close Screen", main_window))
        screen_menu.addAction(QAction(close_all_screens_icon, "Close All Screens", main_window))
        screen_menu.addSeparator()
        screen_menu.addAction(QAction(screen_design_icon, "Screen Design...", main_window))
        screen_menu.addAction(QAction(screen_property_icon, "Screen Property...", main_window))
