...
class CommonMenu:
    ...
    def __init__(self, main_window, menu_bar):
        ...
        comment_menu.addAction(QAction(IconService.get_icon('common-remove-column'), "Remove Column", main_window))
        comment_menu.addAction(QAction(IconService.get_icon('common-remove-row'), "Remove Row", main_window))
        comment_menu.addSeparator()
        comment_menu.addAction(QAction(IconService.get_icon('common-find'), "Find", main_window))
        style_submenu = comment_menu.addMenu(IconService.get_icon('common-style'), "Style")
        style_submenu.addAction(QAction(IconService.get_icon('common-bold'), "Bold", main_window))
        style_submenu.addAction(QAction(IconService.get_icon('common-italic'), "Italic", main_window))
        style_submenu.addAction(QAction(IconService.get_icon('common-underline'), "Underline", main_window))
        style_submenu.addAction(QAction(IconService.get_icon('common-fill'), "Fill", main_window))
