...
class EditMenu:
    ...
    def __init__(self, main_window, menu_bar):
        ...
        self.move_to_front_action = QAction(move_to_front_icon, "Move to Front Layer", self.main_window)
        stacking_order_menu.addAction(self.move_to_front_action)
        self.move_to_back_action = QAction(move_to_back_icon, "Move to Back Layer", self.main_window)
        stacking_order_menu.addAction(self.move_to_back_action)
        self.move_front_layer_action = QAction(move_front_layer_icon, "Move to Front Single Layer", self.main_window)
        stacking_order_menu.addAction(self.move_front_layer_action)
        self.move_back_layer_action = QAction(move_back_layer_icon, "Move to Back Single Layer", self.main_window)
