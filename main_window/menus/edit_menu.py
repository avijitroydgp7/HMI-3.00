...
class EditMenu:
    ...
    def __init__(self, main_window, menu_bar):
        ...
        move_front_layer_icon = qta.icon('fa5s.angle-up', 'fa5s.layer-group', options=[{'color': '#4285f4'}, {'color': '#9aa0a6'}])
        move_back_layer_icon = qta.icon('fa5s.angle-down', 'fa5s.layer-group', options=[{'color': '#4285f4'}, {'color': '#9aa0a6'}])
        move_to_front_icon = qta.icon('fa5s.angle-double-up', 'fa5s.layer-group', options=[{'color': '#34a853'}, {'color': '#9aa0a6'}])
        move_to_back_icon = qta.icon('fa5s.angle-double-down', 'fa5s.layer-group', options=[{'color': '#ea4335'}, {'color': '#9aa0a6'}])
        ...
        align_left_icon = qta.icon('fa5s.align-left', options=[{'color':'#5f6368'}])
        align_center_icon = qta.icon('fa5s.align-center', options=[{'color':'#5f6368'}])
        align_right_icon = qta.icon('fa5s.align-right', options=[{'color':'#5f6368'}])
        align_top_icon = qta.icon('mdi6.format-align-top', options=[{'color':'#5f6368'}])
        align_middle_icon = qta.icon('mdi6.format-align-middle', options=[{'color':'#5f6368'}])
        align_bottom_icon = qta.icon('mdi6.format-align-bottom', options=[{'color':'#5f6368'}])
        dist_horz_icon = qta.icon('mdi6.set-center', options=[{'color':'#4285f4'}])
        dist_vert_icon = qta.icon('mdi6.set-center', options=[{'color':'#4285f4', 'rotated': 90}])
